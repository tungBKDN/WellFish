...
const Products = (props) => { 
  ...
  // }
  console.log(listProduct[0].data.map(item => item.name));

  function productDetails(items) {
    // navigate('/product-details');
    // setItem(items);
    console.log(listProduct.map(item => item.name));
            ...
            
            {
              ...
              listProduct[0].data.map((item) => (
                <div
                  ...
                  className='space-y-3'
                >
                  <img src={item.image_source} alt="" className='rounded-2xl w-[250px] h-[250px]' 
